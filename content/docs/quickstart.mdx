...
See [Learnings API](/docs/learnings-api) for the full instance evidence shape and storage rules.
...
- Manual learning optional fields: `confidence`, `source_goal`, `applicable_goals`, `applicable_tools`, `privacy`, `instances`
