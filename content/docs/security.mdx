...
For Pro and Enterprise customers, Hyperstruck offers guardrails that detect and mask personally identifiable information before it reaches the LLM. This is configurable per agent and can be combined with prompt-injection prevention.
